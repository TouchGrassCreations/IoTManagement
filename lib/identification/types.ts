...
export type ReviewItem = Omit<Detection, "boundingBox" | "confidence"> & { id: string; accepted: boolean; source: "gemini" | "manual"; boundingBox: BoundingBox | null; confidence: number | null; detectedName: string | null; detectedModel: string | null };
export type ConfirmRequest = { token: string; items: ReviewItem[] };
export type InventoryResult = { id: string; name: string; model: string | null; category: string; quantity: number; description: string; tags: string[] };
